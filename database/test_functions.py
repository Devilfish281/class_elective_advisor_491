...
from db_add import add_elective, add_feedback, add_user
from delete_Info import delete_course, delete_feedback, delete_user
from edit_info import change_password, change_prerequisites, change_specialization

DB_PATH = "db/ai_advice.db"
...
def create_test_feedback(user_id, elective_id):
    return add_feedback(
        user_id=user_id, elective_id=elective_id, comment="Great course!", rating=5
    )
